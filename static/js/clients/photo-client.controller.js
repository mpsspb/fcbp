...
(function () {
  ...
  angular
    ...
    .controller('PhotoClientController', PhotoClientController);

  PhotoClientController.$inject = ['$rootScope', '$scope', '$routeParams', 'Clients'];

  /**
  * @namespace PhotoClientController
  */
  function PhotoClientController($rootScope, $scope, $routeParams, Clients) {
    var vm = this;
    ...
    * @memberOf fcbp.client.controllers.PhotoClientController
    */
    function submit() {
      Clients.update(vm.fdata, vm.uid).then(createClientSuccessFn, createClientErrorFn);
      ...
      */
      function createClientSuccessFn(data, status, headers, config) {
        vm.success = true;
        console.log('Success! Client photo update.');
      }
      ...
      */
      function createClientErrorFn(data, status, headers, config) {
        ...
        $rootScope.$broadcast('Client.update.error');
      }
    }
